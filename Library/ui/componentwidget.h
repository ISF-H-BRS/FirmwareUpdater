...
public:
    ...
    void setBootMode(Component::BootMode mode);

    void setBootloaderInfo(const Component::BootloaderInfo& info);
    void setFirmwareInfo(const Component::FirmwareInfo& info);
